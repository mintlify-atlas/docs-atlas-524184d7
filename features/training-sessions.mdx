...
description: "Log every workout with per-set weight, reps, and completion data. Sessions are saved atomically across 3 tables with full history and progressive overload support."
---
