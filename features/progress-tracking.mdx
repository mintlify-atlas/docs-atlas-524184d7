...
description: "Visualize weekly training volume with a Chart.js bar chart and track all-time personal records per exercise. Data is derived from completed sets in sesion_series."
---
