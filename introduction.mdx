...
description: "Blackterz is a full-stack gym management app built with Node.js, Express, and MySQL. These docs cover the REST API, configuration, and frontend integration."
---
