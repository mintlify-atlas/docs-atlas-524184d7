...
description: "Complete reference for every Blackterz .env variable: server port, MySQL connection, JWT secret, SMTP email settings, and AscendAPI key for videos."
---
