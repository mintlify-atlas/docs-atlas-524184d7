---
title: "Blackterz Quickstart: Run the Full API Server Locally"
sidebarTitle: "Quickstart"
description: "Clone the Blackterz repo, set up MySQL, run all database migrations in order, configure your .env, and start the API server on localhost:3000."
---
